...
Built and battle-tested at **Equiti Group** across 750+ devices during a live **PwC IT General Control Review (ITGCR)** audit.
...
```
Loaded 753 serials from serials.txt
...
This will:
- Match serials between `warranty_results.csv` and your `Equiti_Inventory.xlsx`
- Update **Year of Purchase** and **Laptop Age (Yrs)** columns
- Leave all other columns untouched
- Export the updated file as `Equiti_Inventory_updated.xlsx`
...
## Use Case — PwC ITGCR Audit

This tool was purpose-built to support an IT General Control Review audit covering:
...
Built by **Mohammed AlAttar** — Senior Systems Engineer at Equiti Group (UAE) with 19+ years of IT experience.
